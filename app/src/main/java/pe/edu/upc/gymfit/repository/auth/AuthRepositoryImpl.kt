...
import pe.edu.upc.gymfit.repository.buildError
import pe.edu.upc.gymfit.repository.safeApiCall
import pe.edu.upc.gymfit.repository.safeCacheCall
import pe.edu.upc.gymfit.session.SessionManager
import pe.edu.upc.gymfit.ui.auth.state.AuthViewState
import pe.edu.upc.gymfit.ui.auth.state.LoginFields
import pe.edu.upc.gymfit.ui.auth.state.RegistrationFields
import pe.edu.upc.gymfit.util.*
import pe.edu.upc.gymfit.util.ErrorHandling.Companion.ERROR_SAVE_ACCOUNT_PROPERTIES
import pe.edu.upc.gymfit.util.ErrorHandling.Companion.ERROR_SAVE_AUTH_TOKEN
import pe.edu.upc.gymfit.util.ErrorHandling.Companion.GENERIC_AUTH_ERROR
import pe.edu.upc.gymfit.util.ErrorHandling.Companion.INVALID_CREDENTIALS
import pe.edu.upc.gymfit.util.SuccessHandling.Companion.RESPONSE_CHECK_PREVIOUS_AUTH_USER_DONE
